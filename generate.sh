...
python automatic_eval.py -input_dir results/test_set/chunks -output_dir evaluation/results/automatic_eval/chunks -context_len 10
python automatic_eval.py -input_dir results/test_set/articles -output_dir evaluation/results/automatic_eval/articles -context_len 1
